...
// Bots that use Components V2 (containers/sections/text displays) put their

// text inside `message.components`, NOT in `message.content` or `.embeds`.

// Handles both raw API objects and discord.js component instances (`.data`).
